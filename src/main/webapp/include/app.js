...
app.controller('MainCtrl', function ($scope, $rootScope, $http, $log, $timeout, $modal, $filter, uiGridConstants, ajaxService, usSpinnerService) {
  ...
  $scope.setDefaults = function(debugFlag, baseUrl) {
	  categoryLoadUrl 	= baseUrl + "/GT-MOVIES/rest/findbycategory?";
	  titleLoadUrl		= baseUrl + "/GT-MOVIES/rest/findbytitle?";
	  getAllBooksUrl	= baseUrl + "/GT-MOVIES/rest/books";
	  getBookByISBNUrl	= baseUrl + "/GT-MOVIES/rest/getbookbyisbn?";
	  createBookUrl		= baseUrl + "/GT-MOVIES/rest/book/add?";
	  editBookUrl		= baseUrl + "/GT-MOVIES/rest/book/update?";
	  deleteBookUrl		= baseUrl + "/GT-MOVIES/rest/book/delete?";
	  allCategoriesUrl	= baseUrl + "/GT-MOVIES/rest/categories?";
